...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: K2-28aQeKG30/component
import Select__Option from "../../Select__Option"; // plasmic-import: LwlUpOv9qh9-/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: vaHBhkz0Jk-6/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: njeCU3RNgxL9/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: 8QmQp3oXubPH/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: E5IDx33fE1vz/icon
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    ...
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__ygBH)}
                      value={"value2"}
                    >
                      {"Option 2"}
                    </Select__Option>
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__lmLgq)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
