...
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: 0jWiCjztjhKR/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__mzjcM, {
              [sty.freeBoxsmall__mzjcMmMAmk]: hasVariant(
                $state,
                "small",
                "small"
              )
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___21Dwv, {
            [sty.freeBoxsmall___21DwVmMAmk]: hasVariant(
              $state,
              "small",
              "small"
            )
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__upEUt)}>
            {renderPlasmicSlot({
              defaultContents: (
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Rating
                  className={classNames("__wab_instance", sty.rating__gH9Nq)}
                />
              ),
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__gcKlj)}
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
          ...
          <div className={classNames(projectcss.all, sty.freeBox__hcGPb)}>
            {(() => {
              try {
