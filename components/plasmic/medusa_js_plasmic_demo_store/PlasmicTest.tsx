...
import sty from "./PlasmicTest.module.css"; // plasmic-import: uFogk32xWsgK/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <div className={classNames(projectcss.all, sty.freeBox__h0QeG)}>
                  <ProductTextField
                    className={classNames(
                      "__wab_instance",
                      sty.productTextField__hqijw
                    )}
                    field={"title"}
                  />
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <div
                  className={classNames(projectcss.all, sty.freeBox___6M9Iw)}
                >
                  <ProductTextField
                    className={classNames(
                      "__wab_instance",
                      sty.productTextField___7QqEb
                    )}
                    field={"title"}
                  />
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__rku24)}
                  >
                    {(_par =>
