...
import sty from "./PlasmicNavBar.module.css"; // plasmic-import: iugMNW346Myu/css

import HomeIcon from "./icons/PlasmicIcon__Home"; // plasmic-import: QFcDqwesPRsg/icon
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: Gj8Ok3LV05ZK/icon
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: 6SmU5kD6kKpY/icon
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: q3TMxJnPkTxc/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: JftmyozvfNT5/icon
import ProfileIcon from "./icons/PlasmicIcon__Profile"; // plasmic-import: iIi6HbCi9edI/icon
import CartIcon from "./icons/PlasmicIcon__Cart"; // plasmic-import: 6zOnnERWnB17/icon
...
function PlasmicNavBar__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__sOhSg, {
          [sty.freeBoxfilled__sOhSg4KZy]: hasVariant(
            $state,
            "filled",
            "filled"
          ),
          [sty.freeBoxsearchOpen__sOhSgVzqHm]: hasVariant(
            $state,
            "searchOpen",
            "searchOpen"
          )
      ...
      >
        <Button
          ...
          startIcon={
            <HomeIcon
              className={classNames(projectcss.all, sty.svg__a5GFy)}
              role={"img"}
            />
          }
          submitsForm={true}
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__kIGbt, {
            [sty.freeBoxsearchOpen__kIGbtVzqHm]: hasVariant(
              $state,
              "searchOpen",
              "searchOpen"
            )
        ...
        >
          {(hasVariant($state, "searchOpen", "searchOpen") ? false : true) ? (
            <Button
              ...
              startIcon={
                <SearchIcon
                  className={classNames(projectcss.all, sty.svg__pmHpv)}
                  role={"img"}
                />
              }
              submitsForm={true}
          ...
          {false ? (
            <Button
              ...
              startIcon={
                <ProfileIcon
                  className={classNames(projectcss.all, sty.svg__v48T)}
                  role={"img"}
                />
              }
              submitsForm={true}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__qvyTw)}>
            <CartProvider
              ...
              <DataCtxReader__>
                {$ctx => (
                  <Button
                    ...
                    startIcon={
                      <CartIcon
                        className={classNames(projectcss.all, sty.svg__mcCsn)}
                        role={"img"}
                      />
                    }
                    submitsForm={true}
