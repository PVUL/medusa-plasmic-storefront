...
import Price from "../../Price"; // plasmic-import: c-VxXEAGhWZS/component
import Button from "../../Button"; // plasmic-import: hxdFXQNRKdLs/component
import Select from "../../Select"; // plasmic-import: njeCU3RNgxL9/component
import Select__Option from "../../Select__Option"; // plasmic-import: LwlUpOv9qh9-/component
...
import sty from "./PlasmicItem.module.css"; // plasmic-import: 742unshbnHTi/css

import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: Gj8Ok3LV05ZK/icon
import LikeIcon from "./icons/PlasmicIcon__Like"; // plasmic-import: XmdFmQPCD3wD/icon
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  <section
                    className={classNames(projectcss.all, sty.section__bgVz1)}
                  >
                    <Stack__
                      as={"div"}
                    ...
                    >
                      <div
                        className={classNames(projectcss.all, sty.column__g78P)}
                      >
                        <Stack__
                          as={"div"}
                          hasGap={true}
                        ...
                        >
                          <PlasmicImg__
                            alt={""}
                            className={classNames(sty.img__e6RUn)}
                            displayHeight={"auto"}
                            ...
                            src={(() => {
                              try {
                                ...
                                if (
                                  ...
                                  return {
                                    src: "/plasmic/medusa_js_plasmic_demo_store/images/shoe20.png",
                                    fullWidth: 2000,
                                    fullHeight: 2000,
                            ...
                            {(_par =>
                              ...
                              return (
                                ...
                                >
                                  <PlasmicImg__
                                    alt={""}
                                    className={classNames(sty.img__p8Lcw)}
                                    displayHeight={"auto"}
                                    displayMaxHeight={"none"}
                                    displayMaxWidth={"none"}
                                    displayMinHeight={"0"}
          ...
          <section className={classNames(projectcss.all, sty.section__sgrUu)}>
            <div
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__fceWb)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                    ...
                    <Button
                      className={classNames("__wab_instance", sty.button__lijx)}
                      colors={"link"}
                      endIcon={
                        <RightArrowIcon
                          className={classNames(projectcss.all, sty.svg__z3U9O)}
                          role={"img"}
                        />
                      }
                      showEndIcon={true}
            ...
            >
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__ifawd)}
              >
                <ProductCollection
