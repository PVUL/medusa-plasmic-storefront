...
import sty from "./PlasmicCartItem.module.css"; // plasmic-import: dxORelC8bt9W/css

import RecycleIcon from "./icons/PlasmicIcon__Recycle"; // plasmic-import: KvrrIKz79FuJ/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___1OUsC)}
      >
        <PlasmicLink__
          ...
          platform={"nextjs"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__st9Zx)}>
            <div
              className={classNames(
                projectcss.all,
        ...
        {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
          ...
          return (
            <div
              className={classNames(projectcss.all, sty.freeBox__bs6Ol)}
              key={currentIndex}
            >
              <div
                className={classNames(
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__l1QAe)}
        >
          <RecycleIcon
            className={classNames(projectcss.all, sty.svg__bi6Iz)}
            role={"img"}
          />

          <Secure2Icon
            className={classNames(projectcss.all, sty.svg__hzhQm)}
            role={"img"}
          />
        </Stack__>
        <div className={classNames(projectcss.all, sty.freeBox__bZwPj)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
