...
import sty from "./PlasmicValue.module.css"; // plasmic-import: RlvXPa2HohnG/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: J1pdU-0gclDP/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__zpb9Z, {
          [sty.freeBoxcenter__zpb9Z3Ei4G]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__zpb9ZeW3Qp]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__pEqA)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__os1Xq)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vysm5, {
          [sty.freeBoxcenter__vysm53Ei4G]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__vysm5Vuoob]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__f5Vfl, {
            [sty.freeBoxcenter__f5Vfl3Ei4G]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__f5Vflvuoob]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__gqwVb, {
                  [sty.buttonwithButton__gqwVBvuoob]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__lRpb8)}
                    role={"img"}
                  />
                }
                rounded={true}
