...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: vaHBhkz0Jk-6/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: njeCU3RNgxL9/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__vwypq)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__iRv)}
              />
            </React.Fragment>
          ),
          value: args.children
