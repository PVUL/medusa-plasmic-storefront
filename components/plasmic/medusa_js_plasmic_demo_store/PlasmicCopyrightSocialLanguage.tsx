...
import sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: SJrYpb0D7_3T/css

import TwitterIcon from "./icons/PlasmicIcon__Twitter"; // plasmic-import: nDcVjHUVrk4Y/icon
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: Gj8Ok3LV05ZK/icon
import YoutubeIcon from "./icons/PlasmicIcon__Youtube"; // plasmic-import: apU7jXFhWW2w/icon
import PintrestIcon from "./icons/PlasmicIcon__Pintrest"; // plasmic-import: DF1w1IpAg9ij/icon
import Icon15Icon from "./icons/PlasmicIcon__Icon15"; // plasmic-import: uVKjoVB672w7/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__v9DdD)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__gTc7)}
        >
          <div
          ...
          <div className={classNames(projectcss.all, sty.freeBox__xWquf)}>
            <Button
              iconOnly={true}
              link={"http://twitter.com"}
              startIcon={
                <TwitterIcon
                  className={classNames(projectcss.all, sty.svg__eVv8I)}
                  role={"img"}
                />
              }
              submitsForm={true}
            ...
            <Button
              className={classNames("__wab_instance", sty.button___22Gz5)}
              iconOnly={true}
              link={"http://youtube.com"}
              startIcon={
                <YoutubeIcon
                  className={classNames(projectcss.all, sty.svg__j7CU2)}
                  role={"img"}
                />
              }
              submitsForm={true}
            ...
            <Button
              className={classNames("__wab_instance", sty.button__dLwLg)}
              iconOnly={true}
              link={"http://pinterest.com"}
              startIcon={
                <PintrestIcon
                  className={classNames(projectcss.all, sty.svg__lU3M)}
                  role={"img"}
                />
              }
              submitsForm={true}
        ...
        <Button
          className={classNames("__wab_instance", sty.button___9N96U)}
          endIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg__saI6Q)}
              role={"img"}
            />
          }
          showEndIcon={true}
          startIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg__zQOfX)}
              role={"img"}
            />
          }
          submitsForm={true}
